...
<br>
<h4 align="center" >เลือกช่วงวันที่ในการเรียกดูยอดขาย</h4>
<div align="center" class="form-group row">
        ...
        <div class="col-sm-3">
        <button type="submit" name="act" value="rangedate" class="btn btn-success">ค้นหา</button>
        </div>
...
$de = $_GET['de'];
            ...
            AND o_dttm BETWEEN '$ds 00:00:00.000000' AND '$de 23:59:59.000000'
            ...
            <p align="center">
                ...
                datasets: [{
                label: 'รายงานรายได้ แยกตามวันที่เรียกดู (บาท)',
                data: [<?php echo $total
;?>
                ],
                backgroundColor: [
