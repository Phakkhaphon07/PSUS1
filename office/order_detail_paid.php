                ...
                <main>
                        <div class="card mb-4">
                            <div class="card-header"><center>
                                ...
                                รายละเอียดสินค้าชำระเงินเรียบร้อย
                                </h3>
                                </center>
                                <a class = "btn btn-success" target="_blank"  href ='show_order_print.php?o_id=<?php echo $rowd['o_id']?>'><i class='fas fa-print'></i> พิมพ์ใบเสร็จ</a>
                            </div>
                            <div class="card-body">
                            <div  class="table-responsive">
                                <table class="table table-bordered">

                            <h3> ชื่อผู้ชำระเงิน : <?php echo $rowd['members_name']; ?> </h3>
                            <h3> วันเวลาที่ชำระเงิน : <?php echo $new_date; ?> </h3>
