                ...
                <main>
                        <div class="card mb-4">
                            <div class="card-header"><center>
                                <h3><i class="fas fa-hand-holding-usd"></i>
                                รายการชำระเงินเรียบร้อย
                                </h3>
                                </center>
                            </div>
                            <div class="card-body">
                            ...
                            <table id="example3" class="table table-bordered table table-hover" role="grid" aria-describedby="example1_info">
                                    <thead>
                                                ...
                                                <th class="cell"><center>ชื่อผู้ชำระเงิน</center></th>
												                        <th class="cell"><center>วัน/เวลา ที่ชำระเงินเรียบร้อย</center></th>
                                                <th class="cell"><center>ราคาที่ชำระ/บาท</center></th>
 	...
 	<tr>
                                    ...
                                    echo '<b>';
                                     ...
                                     ?>
												...
												<td class="cell"><center>
                                    <?php $o_id = $row['o_id'];
                                    echo "<a href='order_detail_paid.php?o_id=$o_id' class='btn btn-info btn-sm far fa-eye'> ดูรายการชำระเงิน </a>"; ?>
                                    </center></td>
